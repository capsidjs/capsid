...
describe("@on(event)", () => {
  ...
  it("registers the method as the event listener of the given event name", (
    done,
  ) => {
    class Component {
      @on("click")
  ...
  it("registers the method as the event listener for children classes", (
    done,
  ) => {
    class Foo {
      @on("click")
...
describe("@on(event, {at: selector})", () => {
  ...
  it("registers the method as the event listener of the given event name and selector", (
    done,
  ) => {
    class Foo {
