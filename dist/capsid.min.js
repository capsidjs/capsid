var capsid = (function(n) {
  ...
  var o = {},
    ...
    i = new Promise(function(n) {
      var t = function t() {
        'complete' === r.readyState && (n(), r.removeEventListener('readystatechange', t))
      }
    ...
    a = [],
    f = function(n, t) {
      ;(n.$I = !0), (n.$N = t), (n.capsid = q), 'function' == typeof n.__init__ && n.__init__()
    },
    l = function(n, t, e) {
      n.$I || f(n, e)
      var o = new n()
  ...
  var k = g,
    A = $,
    q = Object.freeze({ def: s, prep: u, make: v, mount: l, get: h, on: p, emit: k, emits: g, wire: E, component: S, pub: A, notifies: $, __ccc__: o, pluginHooks: a })
  return (n.def = s), (n.prep = u), (n.make = v), (n.mount = l), (n.get = h), (n.on = p), (n.emit = k), (n.emits = g), (n.wire = E), (n.component = S), (n.pub = A), (n.notifies = $), (n.__ccc__ = o), (n.pluginHooks = a), n
})({})
